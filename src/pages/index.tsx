      ...
      <main className=" w-full h-full md:container mx-auto flex flex-col md:py-10 items-center justify-center min-h-screen gap-4">
        <section className="bg-white text-justify bg-opacity-90 flex gap-4 pb-2 md:py-10 py-2 px-4 md:px-10 flex-col justify-center items-center  md:rounded-2xl">
          ...
          <p className="indent-3 md:indent-10">
            Компания "ГазХимОйл" является частью Группы "CHEMIOL" и была
            основана для работы в новых реалиях на рынках Европы, России и
            Евразийского союза. Опытные и молодые сотрудники группы имеют
            широкие компетенции в проектах в нефтегазовой промышленности - от
            стадий добычи углеводородов до переработки и производства различных
            видов продукции.
          </p>
          <p className="indent-3 md:indent-10">
          ...
          <p className="indent-3 md:indent-10">
            ...
            Российской Федерации, такими как НК"Роснефть", ЛУКОЙЛ, Газпромнефть,
            НОВАТЭК и другими компаниями.
          </p>
        </section>
        <section className="bg-white text-justify bg-opacity-90 flex gap-4 pb-2 md:py-10 py-2 px-4 md:px-10 flex-col justify-center items-center  md:rounded-2xl">
          <h2 className="text-primary text-4xl font-semibold self-start">
          ...
          <article className="p-4 rounded-lg flex flex-col">
            ...
            <p className="indent-3 md:indent-8 text-lg">
              Компания "ГазХимОйл" поздравляет всех партнеров и сотрудников с
              Днем работника нефтяной и газовой промышленности! Руководство
              группы желает всем сотрудникам уверенности в жизни, здоровья и
              достатка в семьях!
            </p>
          </article>
          <article className="p-4 rounded-lg flex flex-col">
